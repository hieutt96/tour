...
@section('content')
	<div class="container">
		...
		@endif
		<form action="/admin/add-tour" enctype="multipart/form-data" method="post">
			{{ csrf_field() }}
			<div class="col-lg-12 row">
				<div class="col-lg-10">
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" name="name" placeholder="" required="true" class="form-control">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" name="vehicle" class="form-control" required="true">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label">Thời gian :</label>
						<div class="col-lg-10">
							<input type="number" name="time" class="form-control" required="true">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" name="start_address" class="form-control" required="true">
						</div>
					</div>
				</div>
				<div class="col-lg-2">
